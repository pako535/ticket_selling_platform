...
class Event(models.Model):
    ...
    student_ticket = models.ForeignKey(Ticket, on_delete=models.DO_NOTHING, related_name='student_ticket',
                                       verbose_name='Student ticket')
    normal_ticket = models.ForeignKey(Ticket, on_delete=models.DO_NOTHING, related_name='normal_ticket',
                                      verbose_name='Normal ticket')
    premium_ticket = models.ForeignKey(Ticket, on_delete=models.DO_NOTHING, related_name='premium_ticket',
                                       verbose_name='Premium ticket')
    vip_ticket = models.ForeignKey(Ticket, on_delete=models.DO_NOTHING, related_name='vip_ticket',
